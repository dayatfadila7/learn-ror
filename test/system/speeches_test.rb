...
class SpeechesTest < ApplicationSystemTestCase
  ...
  test "should create speech" do
    ...
    fill_in "Content", with: @speech.content
    fill_in "Country age", with: @speech.country_age
    fill_in "President name", with: @speech.president_name
    fill_in "Tagline", with: @speech.tagline
